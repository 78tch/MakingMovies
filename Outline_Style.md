...
このとき、推敲の手助けをしてくれる便利なWordの機能が、「見出し行」に「レベル付け」をすることができる、「アウトライン」機能です。  
Wordを「アウトライン」表示にすると、「見出し行」の「レベル」に応じた、入れ子状のツリー表示にすることができます。  
これにより、文書の全体構成や現在の編集位置を把握しながら文章を記述することができますし、見出し行のレベルを「章・節・項」の間で上下させたり、段落の前後を入れ替えたりが簡単にできます。  
