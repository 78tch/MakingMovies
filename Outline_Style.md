...
Wordは、本来、「目次を付けるような、長文を書くためのソフト」です。１枚ものの文書や申請書式などの作成には、実はそれほど向いていません。Wordを使いこなすためには、まずは、本来の用途において基本を押さえた「正しい使い方」を知る必要があります。
## ●１．「アウトライン」機能でまず「目次」を「推敲」しよう
### 「本文」ではなく「目次」から書き始めよう
- 「章・節・項」と３階層に章立てて、まず「目次」を書こう
- 「章を節に下げる」「項を節に上げる」「２章と３章を前後入れ替える」など推敲
- 「表示」を「アウトライン」にしよう
