...
このとき、推敲するのに便利な機能が、「見出し行」に「レベル付け」をすることができる、Wordのアウトライン機能です。  
Wordを「アウトライン」表示とすると、「見出し行」の「レベル」に応じたツリー表示にすることができます。  
これにより、文書の全体構成や現在の編集位置を把握しながら文章を記述することができますし、見出しのレベルを「章・節・項」の間で上下させたり、前後を入れ替えたりが簡単にできます。  章立て粒度を揃えたり、話題の順序を整理したりして、効率よく推敲ができます。
2. 「スタイル」  
