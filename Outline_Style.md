...
それを避けるために、まず文書の全体構造を構想し、章立てを書き出してから、そのあとに各章の本文を書く、という手順をとります。  
このとき、推敲するのに便利な機能が、「見出し行」に「レベル付け」をすることができる、Wordのアウトラインプロセッサ機能です。  
「見出し行」がツリー表示されることで、文書の全体構成や現在の編集位置を把握しながら文章を記述することができます。  
また、見出しのレベル（章・節・項）を上下させたり、前後を入れ替えたりが簡単にできるので、章立ての粒度を揃えたり、話題の順序を整理したりすることで、効率よく推敲ができます。
2. 「スタイル」  
