...
Wordは、本来、目次を付けるような、長文を書くためのソフト（アウトラインプロセッサ）です。アウトラインプロセッサを使えば、文書の全体構成がツリー表示され、現在の編集位置を把握しながら文章を記述することができます。また、見出しの階層レベルを上下させたり、階層ブロックの位置を入れ替えたりすることができるので、効率よく推敲ができます。文書の見栄えも、１枚ものの文書や申請書式などの作成には、実はそれほど向いていません。Wordを使いこなすためには、まずは、本来の用途において基本を押さえた「正しい使い方」を知る必要があります。
